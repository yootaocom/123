...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/123)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/123
```

A live public deployment of this template is available at [https://123.templates.workers.dev](https://123.templates.workers.dev)
